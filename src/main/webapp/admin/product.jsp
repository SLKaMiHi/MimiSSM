...
// alert(str+"11111111");
                   ...
                   $.ajax({
                       ...
                       data:{"pids":str,"pname":pname,"typeid":typeid,"lprice":lprice,"hprice":hprice,"page":page},//提交给服务器的数据
                       type:"post",
                       dataType: "text",
    ...
    function one(pid,page) {
        ...
        //向服务器提交请求，，传递商品Id。将要回显的商品的id传递给one.action
...
<script type="text/javascript">
    function ajaxsplit(page) {
        ...
        var lprice = $("#lprice").val();
        var hprice = $("#hprice").val();
        //向服务器发出异步ajax分页请求，请求page页中的所有数据，在当前页面上显示局部刷新
        $.ajax({
